          ...
          <div className="page-content-inner pt-lg-8 pb-0"> 
            <div className="mb-lg-5" uk-grid="true">
              <div className="uk-width-1-3@m">
                ...
                {/* video demo model */}
                <div id="trailer-modal" uk-modal="true">
                  <div className="uk-modal-dialog">
                    <button className="uk-modal-close-default mt-2  mr-1" type="button" uk-close="true" />
                    <div className="uk-modal-header">
                      <h4> Trailer video </h4>
                    </div>
                    <div className="video-responsive">
                      <iframe src="https://www.youtube.com/embed/nOCXXHGMezU" className="uk-padding-remove" uk-video="automute: true" frameBorder={0} allowFullScreen uk-responsive="true" />
                    </div>
              ...
              <ul id="course-intro-tab" className="uk-switcher mt-4">
                ...
                <li>
                  <ul className="course-curriculum" uk-accordion="multiple: true">
                    ...
                    <li>
                      <a className="uk-accordion-title" href="#"> HTML Advanced level </a>
                      <div className="uk-accordion-content">
                        {/* course-video-list */}
                        <ul className="course-curriculum-list">
                ...
                <li>
                  ...
                  <div className="comments">
                    ...
                    <ul>
                      ...
                      <li>
                        <div className="comments-avatar"><img src="assets/images/avatars/avatar-3.jpg" alt="" />
                        </div>
                        <div className="comment-content">
