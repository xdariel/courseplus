		...
		<div id="trailer-modal" uk-modal="true">
			<div className="uk-modal-dialog">
				...
				<div className="video-responsive">
					<iframe title="" src="https://www.youtube.com/embed/nOCXXHGMezU" className="uk-padding-remove" uk-video="automute: true" frameBorder={0} allowFullScreen={true} uk-responsive="true" />
				</div>
...
export default LeftContentCourseIntro;